    ...
    public partial class PowerPointController : Controller
    {
        ...
        public ActionResult FindAndHighlight(string button, string Group, string Group1, string matchCase, string matchWholeWord, string highlightFirst)
        {
            ...
            if (button == "View Input Template")
            {
                ...
                return new PresentationResult(presentation, "FindAndHighlightInput.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
            }
            else
            {
                string filename = "FindAndHighlightInput.pptx";
                ...
                if (Group1 == "PPTX")
                    ...
                    return new PresentationResult(presentation, "FindandHighlight.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
                else
                {
