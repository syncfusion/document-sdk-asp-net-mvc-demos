...
namespace EJ2MVCSampleBrowser.Controllers
{
    public partial class PowerPointController : Controller
    {
        ...
        public ActionResult HelloWorld(string button)
        {
            if (button == null)
                return View();
            String filename = "HelloWorld.pptx";
            IPresentation presentation = Syncfusion.Presentation.Presentation.Open(ResolveApplicationDataPath(filename));
            ...
            return new PresentationResult(presentation, "HelloWorld.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
