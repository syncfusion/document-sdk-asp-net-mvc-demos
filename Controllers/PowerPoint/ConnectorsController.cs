...
namespace EJ2MVCSampleBrowser.Controllers
{
    public partial class PowerPointController : Controller
    {
        ...
        public ActionResult Connectors(string button)
        {
            if (button == null)
                return View();
            ...
            return new PresentationResult(presentation, "Connectors.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
        }
