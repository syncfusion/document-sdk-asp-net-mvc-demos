...
namespace EJ2MVCSampleBrowser.Controllers
{
    public partial class PowerPointController : Controller
    {
        ...
        public ActionResult CustomizingAppearance(string button, FormCollection form)
        {
            if (button == null)
                return View();
        ...
        if (choice == "PPTX")
        {
            ...
            return new PresentationResult(presentation, "SmartArtSample.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
        }
        else
        {
