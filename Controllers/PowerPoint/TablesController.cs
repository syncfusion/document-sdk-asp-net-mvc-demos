...
namespace EJ2MVCSampleBrowser.Controllers
{
    public partial class PowerPointController : Controller
    {
        ...
        public ActionResult Tables(string button)
        {
            ...
            //Method call to create slides in presentation.
            CreateSlide102(presentation);

            return new PresentationResult(presentation, "Tables.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
           
        }

        #region Slide
        private void CreateSlide102(IPresentation presentation)
        {
