    ...
    public partial class PowerPointController : Controller
    {
            ...
            string findText, string findTextUsingRegex, string findUsing, string replaceText, string replaceFirst)
        {
            ...
            if (button == "View Input Template")
            {
                ...
                return new PresentationResult(presentation, "Input Template.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
            }
            else
            {
                string filename = "Input Template.pptx";
                ...
                return new PresentationResult(presentation, "FindandReplace.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
            }
        }
    }
}