...
namespace EJ2MVCSampleBrowser.Controllers
{
    public partial class PowerPointController : Controller
    {
        ...
        public ActionResult ExcelDataToChart(string button)
        {
            if (button == null)
                return View();
            ...
            return new PresentationResult(presentation, "Chart.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
        }
