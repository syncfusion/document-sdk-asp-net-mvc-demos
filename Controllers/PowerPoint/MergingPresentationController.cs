    ...
    public partial class PowerPointController : Controller
    {
        public ActionResult MergingPresentation(string button, string Group1, string Group2)
        {
            ...
            if (Group1 == "DestinationTheme")
            {
                ...
                return new PresentationResult(destinationPresentation, "MergedUsingDestination.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
            }
            else
            {
                foreach (ISlide slide in slides)
                ...
                return new PresentationResult(destinationPresentation, "MergedUsingSource.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
