...
namespace EJ2MVCSampleBrowser.Controllers
{
    public partial class PowerPointController : Controller
    {
        ...
        public ActionResult Slides(string button)
        {
            ...
            return new PresentationResult(presentation, "Slides.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
        ...
        {
            string dataPath = new System.IO.DirectoryInfo(Request.PhysicalPath + "..\\..\\..\\App_Data\\PowerPoint").FullName;
            return string.Format("{0}\\{1}", dataPath, fileName);
        }

        protected string ResolveApplicationImagePath(string fileName)
        {
            string dataPath = new System.IO.DirectoryInfo(Request.PhysicalPath + "..\\..\\..\\Content\\PowerPoint").FullName;
            return string.Format("{0}\\{1}", dataPath, fileName);
        }
