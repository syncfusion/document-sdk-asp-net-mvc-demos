    ...
    public partial class PowerPointController : Controller
    {
        public ActionResult CloningSlides(string button, string Group1, string Group2)
        {
            ...
            if(Group1 == "DestinationTheme")
            {
                ...
                return new PresentationResult(destinationPresentation, "ClonedUsingDestination.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
            }
            else
            {
                //Adding the cloned slide to the destination presentation by using Destination option.
                ...
                return new PresentationResult(destinationPresentation, "ClonedUsingSource.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
