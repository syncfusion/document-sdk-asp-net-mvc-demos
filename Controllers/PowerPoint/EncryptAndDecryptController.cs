    ...
    public partial class PowerPointController : Controller
    {
        public ActionResult EncryptAndDecrypt(string button, string Group1, string Group2)
        {
            ...
            if (Group1 == "CreateEncryptDoc")
            {
                ...
                return new PresentationResult(presentation, "Encryption.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
            }
            else
            {
                presentation = Syncfusion.Presentation.Presentation.Open(file, "syncfusion");
                presentation.RemoveEncryption();
                return new PresentationResult(presentation, "Decryption.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
            }           
        }
    }
}