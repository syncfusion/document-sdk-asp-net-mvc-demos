...
namespace EJ2MVCSampleBrowser.Controllers
{
    public partial class PowerPointController : Controller
    {
        ...
        public ActionResult Animation(string button)
        {
            if (button == null)
                return View();
            ...
            return new PresentationResult(presentation, "CreateAnimationSample.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
