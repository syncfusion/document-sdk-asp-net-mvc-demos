...
namespace EJ2MVCSampleBrowser.Controllers
{
    public partial class PowerPointController : Controller
    {
        ...
        public ActionResult Comments(string button, FormCollection form)
        {
            if (button == null)
                return View();
            ...
            IPresentation presentation = Syncfusion.Presentation.Presentation.Open(sourceFile);

            //  Method call to create slides
            SlideWithComments1(presentation);
            SlideWithComments2(presentation);
            SlideWithComments3(presentation);

            //  Saves the presentation
            return new PresentationResult(presentation, "Sample.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);          
        }
