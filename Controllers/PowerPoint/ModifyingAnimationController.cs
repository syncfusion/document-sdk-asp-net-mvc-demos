		...
		public ActionResult ModifyingAnimation(string button, string viewbutton)
        {
           if (button == null && viewbutton == null)
            ...
            if (viewbutton == " Input Template ")
            {
                ...
                return new PresentationResult(presentation, "ShapeWithAnimation.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
            }
        else
            {
                string filename = "ShapeWithAnimation.pptx";
                ...
                return new PresentationResult(presentation, "ModifiedAnimationSample.pptx", HttpContext.ApplicationInstance.Response, FormatType.Pptx);
			}
