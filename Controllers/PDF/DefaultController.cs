...
namespace EJ2MVCSampleBrowser.Controllers.PDF
{
    public partial class PdfController : Controller
    {
        ...
        public ActionResult Default(string Browser)
        {
            ...
            PdfImage img = new PdfBitmap(DefaultResolveApplicationImagePath(@"Careers.png"));
            ...
            PdfTrueTypeFont font2 = new PdfTrueTypeFont(f);
            textBoxField2.Font = font2;
            ...
            PdfTrueTypeFont font3 = new PdfTrueTypeFont(f);
            textBoxField3.Font = font3;
            ...
            PdfTrueTypeFont font4 = new PdfTrueTypeFont(f);
            textBoxField4.Font = font4;
            ...
            img = new PdfBitmap(DefaultResolveApplicationImagePath(@"Careers.png"));
            ...
            PdfTrueTypeFont font5 = new PdfTrueTypeFont(f);
            textBoxField5.Font = font5;
            ...
            PdfTrueTypeFont font6 = new PdfTrueTypeFont(f);
            textBoxField6.Font = font6;
            ...
            PdfTrueTypeFont font7 = new PdfTrueTypeFont(f);
            textBoxField7.Font = font7;
            ...
            PdfTrueTypeFont font8 = new PdfTrueTypeFont(f);
            textBoxField8.Font = font8;
            ...
            PdfTrueTypeFont font9 = new PdfTrueTypeFont(f);
            textBoxField9.Font = font9;
        ...
        private string DefaultResolveApplicationImagePath(string fileName)
        {
            //string dataPath = string.Format("{0}\\Common\\Images\\PDF", AppDomain.CurrentDomain.BaseDirectory.ToLower().Split(new string[] { "\\mvc" }, StringSplitOptions.None));
