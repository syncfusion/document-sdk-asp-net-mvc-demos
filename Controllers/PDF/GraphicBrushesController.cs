...
namespace EJ2MVCSampleBrowser.Controllers.PDF
{
    public partial class PdfController : Controller
    {
        ...
        public ActionResult GraphicBrushes(string InsideBrowser)
        {
            ...
            PdfImage image = PdfImage.FromFile(ResolveApplicationImagePath("simple.jpg"));
            ...
            FileStream fs = new FileStream(ResolveApplicationDataPath("rgb.icc"), FileMode.Open, FileAccess.Read);
