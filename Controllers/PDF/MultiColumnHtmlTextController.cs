...
namespace EJ2MVCSampleBrowser.Controllers.PDF
{
    ...
    {
        //
        // GET: /MultiColumnHtmlText/

        public ActionResult MultiColumnHtmlText()
        {
            return View();
        }
        ...
        public ActionResult MultiColumnHTML(string InsideBrowser)
        {
            ...
            ////Drawing Image
            PdfBitmap image = new PdfBitmap(System.Drawing.Image.FromFile(ResolveApplicationImagePath("PDFImage.png")));
            ...
            ////Drawing Image
            image = new PdfBitmap(System.Drawing.Image.FromFile(ResolveApplicationImagePath("Essen PDF.gif")));
        ...
        private void AddFooter(PdfDocument doc, string footerText)
        {
            ...
            compositeField.Draw(footer.Graphics, new PointF(640, 40));
