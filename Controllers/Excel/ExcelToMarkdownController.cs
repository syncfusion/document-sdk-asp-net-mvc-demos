...
namespace EJ2MVCSampleBrowser.Controllers.Excel
{
    public partial class ExcelController : Controller
    {
        ...
        public ActionResult ExcelToMarkdown(string button)
        {
            if (button == null)
                return View();
            else if (button == "Input Template")
            {
                ...
                IWorkbook workbook = application.Workbooks.Open(ResolveApplicationDataPath(@"ExcelToMarkdown.xlsx"));
            ...
            else if(button == "Convert to Markdown")
            {
                ...
                fileStreamResult.FileDownloadName = "ExcelToMarkdown.md";
