...
namespace EJ2MVCSampleBrowser.Controllers.Excel
{
    public partial class ExcelController : Controller
    {
        ...
        public ActionResult Create(string SaveOption)
        {
            ...
            {
                //Save as .xls format
                workbook.SaveAs("CreateSpreadSheet.xls", HttpContext.ApplicationInstance.Response, ExcelDownloadType.PromptDialog, ExcelHttpContentType.Excel97);
            }
            //Save as .xlsx format
            else
            {
                workbook.Version = ExcelVersion.Excel2016;
                workbook.SaveAs("CreateSpreadSheet.xlsx", HttpContext.ApplicationInstance.Response, ExcelDownloadType.PromptDialog, ExcelHttpContentType.Excel2016);
            }
