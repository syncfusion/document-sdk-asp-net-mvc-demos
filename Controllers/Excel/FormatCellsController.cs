...
namespace EJ2MVCSampleBrowser.Controllers.Excel
{
    public partial class ExcelController : Controller
    {
        ...
        public ActionResult FormatCells(string button, string SaveOption)
        {
            if (button == null)
                return View();
            ...
            #region Insert Image
            if (SaveOption == "Xls")
                sheet.Pictures.AddPicture(10, 3, ResolveApplicationImagePath("EMPID1.png"), 66, 63);
            else
            {
                IPictureShape picture = sheet.Pictures.AddPicture(10, 3, ResolveApplicationImagePath("EMPID1.png"));
            ...
            try
            {
                ...
                if (SaveOption == "Xls")
                    return excelEngine.SaveAsActionResult(workbook, "FormatCells.xls", HttpContext.ApplicationInstance.Response, ExcelDownloadType.PromptDialog, ExcelHttpContentType.Excel97);
                else
                    return excelEngine.SaveAsActionResult(workbook, "FormatCells.xlsx", HttpContext.ApplicationInstance.Response, ExcelDownloadType.PromptDialog, ExcelHttpContentType.Excel2016);
            }
            catch (Exception)
            {
            }
