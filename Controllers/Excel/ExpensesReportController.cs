...
namespace EJ2MVCSampleBrowser.Controllers.Excel
{
    public partial class ExcelController : Controller
    {
        ...
        public ActionResult ExpensesReport(string button)
        {
            if (button == null)
                return View();
            ...
            workbook.SaveAs("ExpensesReport.xlsx", HttpContext.ApplicationInstance.Response, ExcelDownloadType.PromptDialog, ExcelHttpContentType.Excel2016);
