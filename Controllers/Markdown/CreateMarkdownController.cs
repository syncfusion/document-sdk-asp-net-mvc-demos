...
namespace EJ2MVCSampleBrowser.Controllers.Markdown
{
    ...
    {
        #region CreateMarkdown
        public ActionResult CreateMarkdown(string button)
        {
            if (button == null)
                return View();
            ...
            if (doc != null)
            {
                ...
                ms.Position = 0;
                FileStreamResult fileStreamResult = new FileStreamResult(ms, "text/markdown");
                fileStreamResult.FileDownloadName = "CreateMarkdown.md";
                return fileStreamResult;
                #endregion saveOption
            }
            return View();
        }
        #endregion CreateMarkdown
    }
