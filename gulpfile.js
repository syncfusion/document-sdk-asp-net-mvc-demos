    ...
    for (let component of samplelists) {
        ...
        for (let sample of samples) {
            ...
            if(title.length > 70 || title.length < 50) {
                throw new Error(`Warning: The title for ${featureName} in ${componentName} is not within the recommended length. Please adjust it.`);
            }
            if (content !== '') {
                ...
                if(description.length > 160 || description.length < 150) {
                   throw new Error(`Warning: The description for ${featureName} in ${metaControlCategory} is not within the recommended length. Please adjust it.`);
                }
